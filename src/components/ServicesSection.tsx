...
const services = [
  {
    ...
    badge: "Express",
    badgeColor: "bg-service-orange/90 text-white border-service-orange",
  ...
  },
  {
    ...
    badge: "Clé en main",
    badgeColor: "bg-service-cyan/90 text-white border-service-cyan",
  ...
  },
  {
    ...
    badge: "Le + demandé",
    badgeColor: "bg-service-blue/90 text-white border-service-blue",
  ...
  },
  {
    ...
    badge: "Connecté",
    badgeColor: "bg-service-violet/90 text-white border-service-violet",
  ...
  },
  {
    ...
    badge: "Urgence 7j/7",
    badgeColor: "bg-service-emerald/90 text-white border-service-emerald",
        ...
        {services.map((s, i) => (
          ...
          >
            <div className="relative h-52 overflow-hidden">
              ...
              <Badge className={`absolute top-4 right-4 text-xs font-bold border ${s.badgeColor} shadow-md backdrop-blur-sm`}>
                {s.badge}
              </Badge>
            </div>
